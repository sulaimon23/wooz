...
import CableTvConfirmationCard from './CableTvConfirmationCard';
...
class CableTvConfirmationTab extends Component {
    render() {
        return (
            <div>
...
export default CableTvConfirmationTab;