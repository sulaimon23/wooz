...
import AirtimeConfirmationCard from './AirtimeConfirmationCard';
...
class AirtimeConfirmationTab extends Component {
    render() {
        return (
            <div>
...
export default AirtimeConfirmationTab;