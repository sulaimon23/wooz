...
import InternetConfirmationTab from '../Utilities/Internet/InternetConfirmationCard'
import BuyInternetDetailsTab from '../Utilities/Internet/BuyInternetDetailsTab';
import ArtimeSuccessDetailsCard from '../Utilities/Internet/InternetSuccessDetailsCard'
...
function getStepContent(stepIndex) {
    switch (stepIndex) {
        case 0:
            return ( <BuyInternetDetailsTab /> );
        case 1:
            return ( <InternetConfirmationTab /> );
        // case 2:
