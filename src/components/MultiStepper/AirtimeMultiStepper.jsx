...
import AirtimeConfirmationTab from '../Utilities/Airtime/AirtimeConfirmationCard'
import BuyAirtimeDetailsTab from '../Utilities/Airtime/BuyAirtimeDetailsTab';
import ArtimeSuccessDetailsCard from '../Utilities/Airtime/AirtimeSuccessDetailsCard'
...
function getSteps() {
  return ['Buy Airtime', 'Confirmation'];
}

function getStepContent(stepIndex) {
    switch (stepIndex) {
        case 0:
            return ( <BuyAirtimeDetailsTab /> );
        case 1:
            return ( <AirtimeConfirmationTab /> );
        // case 2:
