...
import ElectricityConfirmationTab from '../Utilities/Electricity/ElectricityConfirmationCard'
import BuyElectricityDetailsTab from '../Utilities/Electricity/BuyElectricityDetailsTab';
import ArtimeSuccessDetailsCard from '../Utilities/Electricity/ElectricitySuccessDetailsCard'
...
function getSteps() {
  return ['Buy Electricity', 'Confirmation'];
}

function getStepContent(stepIndex) {
    switch (stepIndex) {
        case 0:
            return ( <BuyElectricityDetailsTab /> );
        case 1:
            return ( <ElectricityConfirmationTab /> );
        // case 2:
