                ...
                <Col
                    ...
                    <a href="/onthego/ferries">
                        <Card.Footer
                            ...
                            <h6 style={{ color: '#043f7c', fontSize: '15px' }}>
                                {' '}
                                Ferries{' '}
                            </h6>
                            {/* <h6 style={{ color: '#043f7c', fontSize: '15px' }}> <b>Ferries</b> </h6> */}
                        </Card.Footer>
                    </a>
                </Col>
                <Col
                    ...
                    <a style={{ color: '#ffffff' }} href="/onthego/train">
                        <Card.Footer
                            style={{
                                textAlign: 'center',
                                // marginRight: '-30px',
