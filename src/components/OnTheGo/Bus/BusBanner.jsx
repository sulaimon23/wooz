...
// import bannerimage from '../../assets/img/bannerimg/Bus.png'
import bannerimage from '../../../assets/video/bus.gif'
            ...
            <div style={{ backgroundImage: `url(${bannerimage})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', color: 'white' }} >
                <Container className='p-4xx' style={{ maxWidth: '100%',  }}>
                    ...
                    {/* <Breadcrumb style={{backgroundColor: 'none! important'}} >
                        ...
                        <Breadcrumb.Item active href="/Bus"> <span style={{color: '#043f7c'}}>On The Go</span> </Breadcrumb.Item>
                    </Breadcrumb> */}
                    <Nav className="justify-content-end" activeKey="/home" >
                        <Nav.Item>
                            <Nav.Link  style={{padding: '.5rem 2.5rem'}} href="#">Book Trip</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link  style={{padding: '.5rem 2.5rem'}} eventKey="link-1">Check In</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link style={{padding: '.5rem 2.5rem'}} eventKey="link-2">Print Ticket</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link style={{padding: '.5rem 2.5rem'}} eventKey="link-3">Explore</Nav.Link>
                        </Nav.Item>
                        {/* <Nav.Item>
